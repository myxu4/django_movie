# Generated by Django 4.0.1 on 2022-01-26 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_primer', models.DateField(default=datetime.date.today, verbose_name='Мировая премьера')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.review', verbose_name='Родитель')),
            ],
            options={
                'verbose_name': 'Отзыв',
